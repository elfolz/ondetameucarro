 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function L(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function Yn(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(L())}function ga(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function ma(){const n=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof n=="object"&&n.id!==void 0}function Qs(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function ya(){const n=L();return n.indexOf("MSIE ")>=0||n.indexOf("Trident/")>=0}function Ia(){return Vs.NODE_ADMIN===!0}function va(){try{return typeof indexedDB=="object"}catch{return!1}}function Ea(){return new Promise((n,e)=>{try{let t=!0;const i="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(i);s.onsuccess=()=>{s.result.close(),t||self.indexedDB.deleteDatabase(i),n(!0)},s.onupgradeneeded=()=>{t=!1},s.onerror=()=>{e(s.error?.message||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qc(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(jc()||ma()||"connection"in navigator)?navigator.onLine:!0}function Kc(){if(typeof navigator>"u")return null;const n=navigator;return n.languages&&n.languages[0]||n.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ki(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(_r(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(dr(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(mr(e))return"Blackberry";if(yr(e))return"Webos";if(fr(e))return"Safari";if((e.includes("chrome/")||pr(e))&&!e.includes("edge/"))return"Chrome";if(gr(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,i=n.match(t);if(i?.length===2)return i[1]}return"Other"}function dr(n=L()){return/firefox\//i.test(n)}function fr(n=L()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function pr(n=L()){return/crios\//i.test(n)}function _r(n=L()){return/iemobile/i.test(n)}function gr(n=L()){return/android/i.test(n)}function mr(n=L()){return/blackberry/i.test(n)}function yr(n=L()){return/webos/i.test(n)}function si(n=L()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function cl(n=L()){return si(n)&&!!window.navigator?.standalone}function ll(){return ya()&&document.documentMode===10}function Ir(n=L()){return si(n)||gr(n)||yr(n)||mr(n)||/windows phone/i.test(n)||_r(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let ri={async loadJS(){throw new Error("Unable to load external scripts")},recaptchaV2Script:"",recaptchaEnterpriseScript:"",gapiScript:""};function _l(n){ri=n}function gl(n){return ri.loadJS(n)}function ml(){return ri.gapiScript}function yl(n){return`__${n}${Math.floor(Math.random()*1e6)}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ph=new It(5e3,15e3),_h="__/auth/iframe",gh="emulator/auth/iframe",mh={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},yh=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Ih(n){const e=n.config;_(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?ti(e,gh):`https://${n.config.authDomain}/${_h}`,i={apiKey:e.apiKey,appName:n.name,v:Ye},s=yh.get(n.config.apiHost);s&&(i.eid=s);const r=n._getFrameworks();return r.length&&(i.fw=r.join(",")),`${t}?${Ke(i).slice(1)}`}async function vh(n){const e=await fh(n),t=Y().gapi;return _(t,n,"internal-error"),e.open({where:document.body,url:Ih(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:mh,dontclear:!0},i=>new Promise(async(s,r)=>{await i.restyle({setHideOnLeave:!1});const o=G(n,"network-request-failed"),a=Y().setTimeout(()=>{r(o)},ph.get());function c(){Y().clearTimeout(a),s(i)}i.ping(c).then(c,()=>{r(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gn="webStorageSupport";class Oh{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=Rr,this._completeRedirectFn=nh,this._overrideRedirectResult=Zl}async _openPopup(e,t,i,s){re(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const r=await is(e,t,i,Nn(),s);return bh(e,r,ai())}async _openRedirect(e,t,i,s){await this._originValidation(e);const r=await is(e,t,i,Nn(),s);return Ll(r),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:r}=this.eventManagers[t];return s?Promise.resolve(s):(re(r,"If manager is not set, promise should be"),r)}const i=this.initAndGetManager(e);return this.eventManagers[t]={promise:i},i.catch(()=>{delete this.eventManagers[t]}),i}async initAndGetManager(e){const t=await vh(e),i=new sh(e);return t.register("authEvent",s=>(_(s?.authEvent,e,"invalid-auth-event"),{status:i.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:i},this.iframes[e._key()]=t,i}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(gn,{type:gn},s=>{const r=s?.[0]?.[gn];r!==void 0&&t(!!r),J(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=lh(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Ir()||fr()||si()}}const Dh=Oh;var ss="@firebase/auth",rs="1.11.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mn={},yn={};function ui(n){const e=n.toString();return mn[e]||(mn[e]=new ou),mn[e]}function au(n,e){const t=n.toString();return yn[t]||(yn[t]=e()),yn[t]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gt{static get ALL_TRANSPORTS(){return[Me,V]}static get IS_TRANSPORT_INITIALIZED(){return this.globalTransportInitialized_}constructor(e){this.initTransports_(e)}initTransports_(e){const t=V&&V.isAvailable();let i=t&&!V.previouslyFailed();if(e.webSocketOnly&&(t||U("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."),i=!0),i)this.transports_=[V];else{const s=this.transports_=[];for(const r of gt.ALL_TRANSPORTS)r&&r.isAvailable()&&s.push(r);gt.globalTransportInitialized_=!0}}initialTransport(){if(this.transports_.length>0)return this.transports_[0];throw new Error("No transports available")}upgradeTransport(){return this.transports_.length>1?this.transports_[1]:null}}gt.globalTransportInitialized_=!1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zu=Math.log(2);class Gu{constructor(e){const t=r=>parseInt(Math.log(r)/zu,10),i=r=>parseInt(Array(r+1).join("1"),2);this.count=t(e+1),this.current_=this.count-1;const s=i(this.count);this.bits_=e+1&s}nextBitIsOne(){const e=!(this.bits_&1<<this.current_);return this.current_--,e}}const qt=function(n,e,t,i){n.sort(e);const s=function(c,l){const u=l-c;let h,d;if(u===0)return null;if(u===1)return h=n[c],d=t?t(h):h,new A(d,h.node,A.BLACK,null,null);{const p=parseInt(u/2,10)+c,g=s(c,p),b=s(p+1,l);return h=n[p],d=t?t(h):h,new A(d,h.node,A.BLACK,g,b)}},r=function(c){let l=null,u=null,h=n.length;const d=function(g,b){const N=h-g,q=h;h-=g;const W=s(N+1,q),ve=n[N],ln=t?t(ve):ve;p(new A(ln,ve.node,b,null,W))},p=function(g){l?(l.left=g,l=g):(u=g,l=g)};for(let g=0;g<c.count;++g){const b=c.nextBitIsOne(),N=Math.pow(2,c.count-(g+1));b?d(N,A.BLACK):(d(N,A.BLACK),d(N,A.RED))}return u},o=new Gu(n.length),a=r(o);return new x(i||e,a)};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Yt(){return{value:null,children:new Map}}function go(n,e,t){if(m(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const i=y(e);n.children.has(i)||n.children.set(i,Yt());const s=n.children.get(i);e=T(e),go(s,e,t)}}function xn(n,e,t){n.value!==null?t(e,n.value):nd(n,(i,s)=>{const r=new S(e.toString()+"/"+i);xn(s,r,t)})}function nd(n,e){n.children.forEach((t,i)=>{e(i,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var K;(function(n){n[n.OVERWRITE=0]="OVERWRITE",n[n.MERGE=1]="MERGE",n[n.ACK_USER_WRITE=2]="ACK_USER_WRITE",n[n.LISTEN_COMPLETE=3]="LISTEN_COMPLETE"})(K||(K={}));function mo(){return{fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}function yo(){return{fromUser:!1,fromServer:!0,queryId:null,tagged:!1}}function Io(n){return{fromUser:!1,fromServer:!0,queryId:n,tagged:!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jt{constructor(e,t,i){this.path=e,this.affectedTree=t,this.revert=i,this.type=K.ACK_USER_WRITE,this.source=mo()}operationForChild(e){if(m(this.path)){if(this.affectedTree.value!=null)return f(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new S(e));return new Jt(w(),t,this.revert)}}else return f(y(this.path)===e,"operationForChild called for unrelated child."),new Jt(T(this.path),this.affectedTree,this.revert)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ke{constructor(e,t,i){this.source=e,this.path=t,this.snap=i,this.type=K.OVERWRITE}operationForChild(e){return m(this.path)?new ke(this.source,w(),this.snap.getImmediateChild(e)):new ke(this.source,T(this.path),this.snap)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mt{constructor(e,t,i){this.source=e,this.path=t,this.children=i,this.type=K.MERGE}operationForChild(e){if(m(this.path)){const t=this.children.subtree(new S(e));return t.isEmpty()?null:t.value?new ke(this.source,w(),t.value):new mt(this.source,w(),t)}else return f(y(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new mt(this.source,T(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function vo(n,e){return{eventCache:n,serverCache:e}}function ut(n,e,t,i){return vo(new gi(e,t,i),n.serverCache)}function Eo(n,e,t,i){return vo(n.eventCache,new gi(e,t,i))}function Un(n){return n.eventCache.isFullyInitialized()?n.eventCache.getNode():null}function Ne(n){return n.serverCache.isFullyInitialized()?n.serverCache.getNode():null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Co(n,e){return Ao(e,n)}function ud(n,e,t,i,s){f(i>n.lastWriteId,"Stacking an older write on top of newer ones"),s===void 0&&(s=!0),n.allWrites.push({path:e,snap:t,writeId:i,visible:s}),s&&(n.visibleWrites=dt(n.visibleWrites,e,t)),n.lastWriteId=i}function dd(n,e){for(let t=0;t<n.allWrites.length;t++){const i=n.allWrites[t];if(i.writeId===e)return i}return null}function fd(n,e){const t=n.allWrites.findIndex(a=>a.writeId===e);f(t>=0,"removeWrite called with nonexistent writeId.");const i=n.allWrites[t];n.allWrites.splice(t,1);let s=i.visible,r=!1,o=n.allWrites.length-1;for(;s&&o>=0;){const a=n.allWrites[o];a.visible&&(o>=t&&pd(a,i.path)?s=!1:z(i.path,a.path)&&(r=!0)),o--}if(s){if(r)return _d(n),!0;if(i.snap)n.visibleWrites=ks(n.visibleWrites,i.path);else{const a=i.children;B(a,c=>{n.visibleWrites=ks(n.visibleWrites,k(i.path,c))})}return!0}else return!1}function pd(n,e){if(n.snap)return z(n.path,e);for(const t in n.children)if(n.children.hasOwnProperty(t)&&z(k(n.path,t),e))return!0;return!1}function _d(n){n.visibleWrites=To(n.allWrites,gd,w()),n.allWrites.length>0?n.lastWriteId=n.allWrites[n.allWrites.length-1].writeId:n.lastWriteId=-1}function gd(n){return n.visible}function To(n,e,t){let i=j.empty();for(let s=0;s<n.length;++s){const r=n[s];if(e(r)){const o=r.path;let a;if(r.snap)z(t,o)?(a=F(t,o),i=dt(i,a,r.snap)):z(o,t)&&(a=F(o,t),i=dt(i,w(),r.snap.getChild(a)));else if(r.children){if(z(t,o))a=F(t,o),i=As(i,a,r.children);else if(z(o,t))if(a=F(o,t),m(a))i=As(i,w(),r.children);else{const c=He(r.children,y(a));if(c){const l=c.getChild(T(a));i=dt(i,w(),l)}}}else throw je("WriteRecord should have .snap or .children")}}return i}function So(n,e,t,i,s){if(!i&&!s){const r=Pe(n.visibleWrites,e);if(r!=null)return r;{const o=ge(n.visibleWrites,e);if(Bn(o))return t;if(t==null&&!Fn(o,w()))return null;{const a=t||v.EMPTY_NODE;return Ge(o,a)}}}else{const r=ge(n.visibleWrites,e);if(!s&&Bn(r))return t;if(!s&&t==null&&!Fn(r,w()))return null;{const o=function(l){return(l.visible||s)&&(!i||!~i.indexOf(l.writeId))&&(z(l.path,e)||z(e,l.path))},a=To(n.allWrites,o,e),c=t||v.EMPTY_NODE;return Ge(a,c)}}}function md(n,e,t){let i=v.EMPTY_NODE;const s=Pe(n.visibleWrites,e);if(s)return s.isLeafNode()||s.forEachChild(M,(r,o)=>{i=i.updateImmediateChild(r,o)}),i;if(t){const r=ge(n.visibleWrites,e);return t.forEachChild(M,(o,a)=>{const c=Ge(ge(r,new S(o)),a);i=i.updateImmediateChild(o,c)}),Ns(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}else{const r=ge(n.visibleWrites,e);return Ns(r).forEach(o=>{i=i.updateImmediateChild(o.name,o.node)}),i}}function yd(n,e,t,i,s){f(i||s,"Either existingEventSnap or existingServerSnap must exist");const r=k(e,t);if(Fn(n.visibleWrites,r))return null;{const o=ge(n.visibleWrites,r);return Bn(o)?s.getChild(t):Ge(o,s.getChild(t))}}function Id(n,e,t,i){const s=k(e,t),r=Pe(n.visibleWrites,s);if(r!=null)return r;if(i.isCompleteForChild(t)){const o=ge(n.visibleWrites,s);return Ge(o,i.getNode().getImmediateChild(t))}else return null}function vd(n,e){return Pe(n.visibleWrites,e)}function Ed(n,e,t,i,s,r,o){let a;const c=ge(n.visibleWrites,e),l=Pe(c,w());if(l!=null)a=l;else if(t!=null)a=Ge(c,t);else return[];if(a=a.withIndex(o),!a.isEmpty()&&!a.isLeafNode()){const u=[],h=o.getCompare(),d=r?a.getReverseIteratorFrom(i,o):a.getIteratorFrom(i,o);let p=d.getNext();for(;p&&u.length<s;)h(p,i)!==0&&u.push(p),p=d.getNext();return u}else return[]}function wd(){return{visibleWrites:j.empty(),allWrites:[],lastWriteId:-1}}function Wn(n,e,t,i){return So(n.writeTree,n.treePath,e,t,i)}function bo(n,e){return md(n.writeTree,n.treePath,e)}function Ps(n,e,t,i){return yd(n.writeTree,n.treePath,e,t,i)}function Qt(n,e){return vd(n.writeTree,k(n.treePath,e))}function Cd(n,e,t,i,s,r){return Ed(n.writeTree,n.treePath,e,t,i,s,r)}function mi(n,e,t){return Id(n.writeTree,n.treePath,e,t)}function Ro(n,e){return Ao(k(n.treePath,e),n.writeTree)}function Ao(n,e){return{treePath:n,writeTree:e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xs;function xd(n){f(!xs,"__referenceConstructor has already been defined"),xs=n}class Us{constructor(e){this.listenProvider_=e,this.syncPointTree_=new C(null),this.pendingWriteTree_=wd(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Ud(n,e,t,i,s){return ud(n.pendingWriteTree_,e,t,i,s),s?on(n,new ke(mo(),e,t)):[]}function Le(n,e,t=!1){const i=dd(n.pendingWriteTree_,e);if(fd(n.pendingWriteTree_,e)){let r=new C(null);return i.snap!=null?r=r.set(w(),!0):B(i.children,o=>{r=r.set(new S(o),!0)}),on(n,new Jt(i.path,r,t))}else return[]}function rn(n,e,t){return on(n,new ke(yo(),e,t))}function Fd(n,e,t){const i=C.fromObject(t);return on(n,new mt(yo(),e,i))}function Bd(n,e,t,i){const s=Mo(n,i);if(s!=null){const r=Lo(s),o=r.path,a=r.queryId,c=F(o,e),l=new ke(Io(a),c,t);return xo(n,o,l)}else return[]}function Wd(n,e,t,i){const s=Mo(n,i);if(s){const r=Lo(s),o=r.path,a=r.queryId,c=F(o,e),l=C.fromObject(t),u=new mt(Io(a),c,l);return xo(n,o,u)}else return[]}function Po(n,e,t){const s=n.pendingWriteTree_,r=n.syncPointTree_.findOnPath(e,(o,a)=>{const c=F(o,e),l=vi(a,c);if(l)return l});return So(s,e,r,t,!0)}function on(n,e){return Oo(e,n.syncPointTree_,null,Co(n.pendingWriteTree_,w()))}function Oo(n,e,t,i){if(m(n.path))return Do(n,e,t,i);{const s=e.get(w());t==null&&s!=null&&(t=vi(s,w()));let r=[];const o=y(n.path),a=n.operationForChild(o),c=e.children.get(o);if(c&&a){const l=t?t.getImmediateChild(o):null,u=Ro(i,o);r=r.concat(Oo(a,c,l,u))}return s&&(r=r.concat(Ii(s,n,i,t))),r}}function Do(n,e,t,i){const s=e.get(w());t==null&&s!=null&&(t=vi(s,w()));let r=[];return e.children.inorderTraversal((o,a)=>{const c=t?t.getImmediateChild(o):null,l=Ro(i,o),u=n.operationForChild(o);u&&(r=r.concat(Do(u,a,c,l)))}),s&&(r=r.concat(Ii(s,n,i,t))),r}function Mo(n,e){return n.tagToQueryMap.get(e)}function Lo(n){const e=n.indexOf("$");return f(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new S(n.substr(0,e))}}function xo(n,e,t){const i=n.syncPointTree_.get(e);f(i,"Missing sync point for query tag that we're tracking");const s=Co(n.pendingWriteTree_,e);return Ii(i,t,s,null)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mf(n){let e="";const t=n.split("/");for(let i=0;i<t.length;i++)if(t[i].length>0){let s=t[i];try{s=decodeURIComponent(s.replace(/\+/g," "))}catch{}e+="/"+s}return e}function yf(n){const e={};n.charAt(0)==="?"&&(n=n.substring(1));for(const t of n.split("&")){if(t.length===0)continue;const i=t.split("=");i.length===2?e[decodeURIComponent(i[0])]=decodeURIComponent(i[1]):U(`Invalid query segment '${t}' in query '${n}'`)}return e}const Hs=function(n,e){const t=If(n),i=t.namespace;t.domain==="firebase.com"&&ae(t.host+" is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),(!i||i==="undefined")&&t.domain!=="localhost"&&ae("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),t.secure||Kh();const s=t.scheme==="ws"||t.scheme==="wss";return{repoInfo:new Jr(t.host,t.secure,i,s,e,"",i!==t.subdomain),path:new S(t.pathString)}},If=function(n){let e="",t="",i="",s="",r="",o=!0,a="https",c=443;if(typeof n=="string"){let l=n.indexOf("//");l>=0&&(a=n.substring(0,l-1),n=n.substring(l+2));let u=n.indexOf("/");u===-1&&(u=n.length);let h=n.indexOf("?");h===-1&&(h=n.length),e=n.substring(0,Math.min(u,h)),u<h&&(s=mf(n.substring(u,h)));const d=yf(n.substring(Math.min(n.length,h)));l=e.indexOf(":"),l>=0?(o=a==="https"||a==="wss",c=parseInt(e.substring(l+1),10)):l=e.length;const p=e.slice(0,l);if(p.toLowerCase()==="localhost")t="localhost";else if(p.split(".").length<=2)t=p;else{const g=e.indexOf(".");i=e.substring(0,g).toLowerCase(),t=e.substring(g+1),r=i}"ns"in d&&(r=d.ns)}return{host:e,port:c,domain:t,subdomain:i,secure:o,scheme:a,pathString:s,namespace:r}};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
